...
export default class SceneManager extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {current_scene:this.props.current_scene, color:'red', scene_array:[
    ...
    mazeScene(){
        return(
        <Entity>
            <Entity primitive="a-sky" id="sky" height="2048" radius="30" src="#skyTexture" theta-length="90" width="2048"/>
            <Entity primitive="a-box" id="center" position="0 0 0" color="red" depth="0.5" width="0.5" height="10"/>
            <Entity primitive="a-entity" id="amze" maze='size: 9 12;' position='0 0 0' />
        </Entity>
        )
    }
